...
export const achievements = [
  ...
  { id: 4, name: "Track breakfast", icon: "meal", type: "Daily", reward: 20, max: 1, triggers: [TRIGGERS.ADD_MEAL], evaluate: (p, ctx) => ({ progress: p.type === 'breakfast' || ctx.meals.some(m => m.type === 'breakfast') ? 1 : ctx.item.progress }) },
