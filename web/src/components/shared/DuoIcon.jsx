...
export const IconStarOutline = ({ size = 16, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 256 256" fill="none">
    <path
      d="M239.18,97.26A16.38,16.38,0,0,0,224.92,86l-59.46-4.76-22.25-55.2a16.36,16.36,0,0,0-30.42,0L90.54,81.26,31.08,86a16.46,16.46,0,0,0-9.37,28.86l45,38.83L53,211.75a16.38,16.38,0,0,0,24.5,17.82L128,198.49l50.53,31.08A16.38,16.38,0,0,0,203,211.75l-13.76-58.07,45-38.83A16.38,16.38,0,0,0,239.18,97.26Zm-15.34,5.47-48.7,42a8,8,0,0,0-2.56,7.91l14.88,62.8a.37.37,0,0,1-.17.48c-.18.14-.23.11-.38,0l-54.72-33.65a8,8,0,0,0-8.38,0L69.09,215.94c-.15.09-.2.12-.38,0a.37.37,0,0,1-.17-.48l14.88-62.8a8,8,0,0,0-2.56-7.91l-48.7-42c-.12-.1-.23-.19-.13-.5s.18-.27.33-.29l64.32-5.16a8,8,0,0,0,6.72-4.93l24.16-59.95a.37.37,0,0,1,.68,0l24.16,59.95a8,8,0,0,0,6.72,4.93l64.32,5.16c.15,0,.22,0,.33.29S223.96,102.83,223.84,102.73Z"
      fill={color}
    />
  </svg>
);
...
export const IconSparkles = ({ size = 20, color = "currentColor" }) => (
  <DuoIcon size={size} color={color}>
    <path d="M128,24l18,52,52,18-52,18-18,52-18-52L58,94l52-18Z" />
    <path d="M192,144l9,26,26,9-26,9-9,26-9-26-26-9,26-9Z M64,152l8,22,22,8-22,8-8,22-8-22-22-8,22-8Z" />
  </DuoIcon>
);
...
export const IconCrown = ({ size = 20, color = "currentColor" }) => (
  <DuoIcon size={size} color={color}>
    <polygon points="24 192 48 80 96 136 128 48 160 136 208 80 232 192 24 192" />
    <path d="M232,184l-24-112a8,8,0,0,0-14.77-2.67L160,119.86,135.25,51.81a8,8,0,0,0-14.5,0L96,119.86,62.77,69.33A8,8,0,0,0,48,72L24,184a8,8,0,0,0,7.84,9.68H224.16A8,8,0,0,0,232,184ZM42.13,177.68l18.42-86,29.17,44.27a8,8,0,0,0,13.62-.2L128,81.18l24.66,54.57a8,8,0,0,0,13.62.2l29.17-44.27,18.42,86Z" />
  </DuoIcon>
);
...
export const IconInfo = ({ size = 20, color = "currentColor" }) => (
  <DuoIcon size={size} color={color}>
    <circle cx="128" cy="128" r="96" />
    <path d="M128,24A104,104,0,1,0,232,128,104.11,104.11,0,0,0,128,24Zm0,192a88,88,0,1,1,88-88A88.1,88.1,0,0,1,128,216Zm16-40a8,8,0,0,1-8,8,16,16,0,0,1-16-16V128a8,8,0,0,1,0-16,16,16,0,0,1,16,16v40A8,8,0,0,1,144,176ZM124,80a12,12,0,1,1,12,12A12,12,0,0,1,124,80Z" />
  </DuoIcon>
);
